    ...
    <div>
      ...
      <section>
        ...
        <p className="text-sm w-[80%] ml-auto leading-6 py-10">
          ...
          molestiae, impedit asperiores earum exercitationem maxime odio libero
          illum, voluptatem ratione consequatur. Iusto minima unde atque quam
          voluptatum omnis quisquam mollitia maxime deserunt commodi blanditiis
          eligendi tenetur, ea dicta esse quos, facere a eius fugiat rerum fugit
          debitis reprehenderit eveniet! Velit.
        </p>
      </section>
      ...
      <div className="px-5">
        <h1 className="text-2xl w-[60%]">
          The Iconic <span className="slant block text-right">Difference</span>
        </h1>
      ...
      <section className="py-14 px-5">
        <p className="text-base border-b-[1px] pt-4 pb-6 leading-7">
          <span className="text-3xl font-light block">{ffiData.products}+</span>{" "}
        ...
        <p className="text-base border-b-[1px] pt-4 pb-6 leading-7">
          <span className="text-3xl font-light block">{ffiData.years}+</span>{" "}
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-5">
            ...
            <p>
              ...
              play–but we don’t win in silos. We know in order to succeed, we
              must do it together. We embrace the diversity of our
              locations,perspectives, and experiences to succeed as one company.
            </p>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <p>
              ...
              inclusivity, and diversity. We meet people where they are, as they
              are, and prioritize accessibility, by connecting with kindness and
              empathy
            </p>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <p>
              ...
              when no one is looking. It is vital to us that our community and
              teammates know that they can rely on our products, information,
              and perspective.
            </p>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <p>
              ...
              bravely curious and optimistic about our ideas for the future, and
              exploration is in our DNA. We act with courage, challenge the
              status quo, take risks, and discover new. We execute with
              excellence.
            </p>
          </div>
          <div className="flex flex-col gap-5">
            ...
            <p>
              We confront obstacles head-on. Even if we disagree, we share one
              common goal: solving the problem, together.
            </p>
          </div>
        </div>
      </section>
