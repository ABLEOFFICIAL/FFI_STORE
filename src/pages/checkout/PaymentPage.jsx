  ...
  return (
    <section className="p-5">
      ...
      <div className="flex gap-5 mt-10">
        <div className="bg-[#4a4741] text-[#f7f1e8] w-[120px] flex flex-col justify-center items-center shadow-md rounded-lg p-2">
          <img
            src={img2}
        ...
        <div className="flex justify-between items-center px-2 pr-4  bg-white h-[15vh] rounded-lg shadow-md mb-7">
          ...
          {toggle ? (
            <span
              ...
              className="w-7 bg-transparent h-7 p-3 border-[1px] border-[#4a4741] rounded-full flex justify-center items-center"
            >
